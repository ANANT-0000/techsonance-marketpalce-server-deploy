...
export const SHIPROCKET_URLS = {
  ...
  SHIP_ROCKET_ADD_PICKUP: `${SHIPROCKET_BASE}/v1/external/settings/company/addpickup`,
  SHIP_ROCKET_REQUEST_FOR_SHIPMENT_PICKUP: `${SHIPROCKET_BASE}/v1/external/courier/generate/pickup`,
  CREATE_RETURN_ORDER: `${SHIPROCKET_BASE}/v1/external/orders/create/return`,
  SHIP_ROCKET_UPDATE_ORDER_IN_A_SHIPMENT_API: `${SHIPROCKET_BASE}/v1/external/orders/update/shipment`,
} as const;
