...
import { refresh_tokens } from '../../../drizzle/schema/index.js';
import { user } from '../../../drizzle/schema/users.schema.js';
import { type DrizzleDB } from '../../../drizzle/types/drizzle.js';
import { BadRequestException } from '@nestjs/common';
import { userRegistrationTemplate } from './templates/user-registration.template.js';
import { vendorRegistrationTemplate } from './templates/vendor-registration.template.js';
import { orderPlacedTemplate } from './templates/order-placed.template.js';
import { orderCancelledTemplate } from './templates/order-cancelled.template.js';
import { orderReturnTemplate } from './templates/order-return.template.js';
import { orderReplacementTemplate } from './templates/order-replacement-approve.template.js';
import { returnRequestedTemplate } from './templates/return-requested.template.js';
